...
INPUTPATH = "d:\\esoexport\\goodimages4\\combinedmaps\\"
INPUTPATH = "d:\\esoexport\\goodimages4\\combinedmaps\\edraldundercroft\\"
OUTPUTPATH = "d:\\esoexport\\maptiles4\\"
DEFAULTNULLTILE = "d:\\esoexport\\maptiles4\\blacknulltile.jpg"
MAPEXTENSION = ".jpg"
MAXZOOMLEVEL = 10
OUTPUTIMAGESIZE = 256

ONLYDOMAP = "edraldundercroftupper"
...
def DumpMapInfo (OutputFilename):
    ...
    for MapInfo in g_MapInfos:
        f.write("{0}, {1}, {2}, {3}, {4}\n".format(MapInfo.name, MapInfo.minZoom, MapInfo.maxZoom, MapInfo.numTilesX, MapInfo.numTilesY))
...
#IterateMapRootPaths()
#CreateLowerZoomLevesl(INPUTPATH, ONLYDOMAP):
SplitMap(INPUTPATH, ONLYDOMAP + ".jpg")
