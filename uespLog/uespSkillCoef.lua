...
uespLog.UESP_POWERTYPE_HERALDOFTHETOME = -80
uespLog.UESP_POWERTYPE_SOLDIEROFAPOCRYPHA = -81
...
uespLog.SKILLCOEF_MECHANIC_NAMES = {
	...
	[uespLog.UESP_POWERTYPE_HERALDOFTHETOME] = "Herald of the Tome Skills Slotted",
	[uespLog.UESP_POWERTYPE_SOLDIEROFAPOCRYPHA] = "Soldier of Apocrypha Skills Slotted",
}
...
-- Passives 
	...
	-- Arcanist Splintered Secrets
	[184885] = { [2] = uespLog.UESP_POWERTYPE_HERALDOFTHETOME },
	[184887] = { [2] = uespLog.UESP_POWERTYPE_HERALDOFTHETOME },
