...
def CreateDBOutput (OutputFilename):
    ...
    for i, row in enumerate(g_NewMaps):
        ...
        SqlString += "INSERT INTO uesp_gamemap.world_history(worldId, revisionId, parentId, name, displayName, minZoom, maxZoom, zoomOffset, posLeft, posTop, posRight, posBottom, enabled, tilesX, tilesY, defaultZoom, maxTilesX, maxTilesY, displayData) VALUES({0}, @revision_id, {9}, \"{1}\", \"{8}\", {3}, {2}, {3}, {4}, {5}, {6}, {7}, 1, {10}, {11}, {12}, {13}, {14}, '{15}');\n".format(ID, mapInfo[MAPNAME], MAX_ZOOM_VALUE, mapInfo[MINZOOM], posLeft, posTop, posRight, posBottom, mapDisplayName, mapParentID, tilesX, tilesY, defaultZoom, maxTilesX, maxTilesY, displayData)
